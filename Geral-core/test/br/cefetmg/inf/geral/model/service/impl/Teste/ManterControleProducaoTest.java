...
import br.cefetmg.inf.geral.model.service.impl.ManterControleProducao;
 ...
 * @author Eduardo
 */
public class ManterControleProducaoTest {
    
    public ManterControleProducaoTest() {
    }
    
@Test
    public void testCadastrar() throws Exception {
        ManterControleProducao objeto = new ManterControleProducao();
    ...
    public void testExcluir() throws Exception {
     ...
     public void testPesquisarPorCod() throws Exception {
        ...
        try{
            ControleProducao pesquisarPorSeq = objeto.pesquisarPorSeq(null);
        } catch (PersistenciaException e) {
            return;
        }
        fail("O teste não passou!!");
