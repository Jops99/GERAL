...
import br.cefetmg.inf.geral.model.service.impl.ManterVacina;
 ...
 * @author Eduardo
 */
public class ManterVacinaTest {
    
    public ManterVacinaTest() {
    }
    
     
    @Test
    public void testCadastrar() throws Exception {
        ManterVacina objeto = new ManterVacina();
    ...
    public void testExcluir() throws Exception {
     ...
     public void testPesquisarPorCod() throws Exception {
        ...
        try{
            Vacina pesquisarPorCod = objeto.pesquisarPorCod(null);
        } catch (PersistenciaException e) {
            return;
        }
        fail("O teste não passou!!");
